...
@Component
public class McpClientRegistrationRepository implements ClientRegistrationRepository, Iterable<ClientRegistration> {

    private final ConcurrentMap<String, ClientRegistration> registrations = new ConcurrentHashMap<>();
