...
/*
 * TODO(spring-ai-playground): TEMPORARY VENDORED OVERRIDE.
 * Remove when upstream Spring AI includes fix from <https://github.com/spring-projects/spring-ai/pull/4951>.
 * Based on spring-ai <feedfc6c7b4f08128d3ec2b918beeccb8dfb09e3>.
    ...
    private ChatResponse internalCall(Prompt prompt, ChatResponse previousChatResponse) {
        ...
        ChatResponse response = ChatModelObservationDocumentation.CHAT_MODEL_OPERATION
                ...
                .observe(() -> {
                    ...
                    OllamaApi.ChatResponse ollamaResponse =
                            this.retryTemplate.execute(retryContext ->  this.chatApi.chat(request));
